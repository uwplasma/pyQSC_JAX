...
| Magnetic shear | Rodríguez et al. shear equations | pyQSC `calculate_r3.py` | upstream shear and \(\iota_2\), asymmetric cases, resolution convergence, AD | not implemented |
